...
class WeatherContainer extends BaseComponent {
  ...
  loadCurrentWeather = () => {
    this.state.value === "" ||
    cities.find(city => city.name === this.state.value) === undefined
      ? this.loadLocation()
      : this.requestAPI(this.state.value);
  };
  ...
  requestAPI = cityName => {
    if (cities.find(city => city.name === cityName) !== undefined) {
      ...
      let url =
        ...
        "?apikey=" +
        key +
        "&language=vi&details=true&metric=true";
      axios
        .get(url)
        .then(response => {
          this.setState({
        ...
        <div className="hero">
          <div className="container">
            <div className="find-location">
              ...
              />
              <button
                className="load-weather"
                onClick={this.loadCurrentWeather}
              >
                Get weather
              </button>
            </div>
